-- ============================================================
-- MISE À JOUR du 23/07/2026 : à coller dans l'éditeur SQL de
-- Supabase sur une base DÉJÀ installée. Sans risque si certaines
-- parties ont déjà été appliquées (tout est idempotent).
-- ============================================================
